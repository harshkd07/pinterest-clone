...
function Create() {
  ...
  const addPinHandler = (e) => {
    ...
    addPin(formData, setFile, setFilePrev, setPin, setTitle, navigate);
  };
      ...
      <div className="flex flex-wrap justify-center items-center gap-2 mt-10">
        <div className="flex items-center justify-center">
          <div className="flex flex-col items-center justify-center w-80 h-auto p-6 bg-white rounded-lg shadow-lg">
            {filePrev && <img className="mb-2" src={filePrev} alt="" />}
            <div
        ...
        <div>
          <div className="flex items-center justify-center bg-gray-100">
            ...
            >
              ...
              {loading ? <button disabled className="common-btn">please wait..</button> : <button type="submit" className="common-btn"> Add +</button>}
            </form>
          </div>
        </div>
      </div>
